  ...
  settings = await cl.ChatSettings(
            [
                cl.input_widget.Select(
                    id="Model",
                    label="Model",
                    values=["gpt-4", "AI-Growth-Lab_llama-2-7b-clinical-innovation", "mistralai_Mixtral-8x7B-Instruct-v0.1", "meditron-7b", "TheBloke_meditron-7B-GPTQ", "Kabster_BioMistral-MedicalQA-FT", "meta-llama_Meta-Llama-3-8B"],
                    initial_index=0
                ),
                cl.input_widget.Select(
                    id="DataExtract",
